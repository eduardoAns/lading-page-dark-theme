...
export const Footer = () => {
  return (
    <section className=' h-screen w-full flex flex-col justify-center items-center bg-primary-300'>
        <article className='h-11 mb-10 pl-2 w-4/5'>
            <img className='inline h-full ' src="images/logo.svg" alt="Logo" />
        </article>
        <div className='w-4/5 flex flex-col font-raleway sm:flex-row'>
            <article className='flex flex-row text-sm mb-4 sm:w-2/6'>
            ...
            <article className='text-sm mb-16 sm:w-1/6 '>
            ...
            <article className='flex flex-col gap-4 text-sm mb-14 sm:w-1/6 sm:items-end '>
                <a href='#' className=' w-20'>About Us</a>
                <a href='#' className=' w-20'>Jobs</a>
                <a href='#' className=' w-20'>Press</a>
                <a href='#' className=' w-20'>Blog</a>
            </article>
            <article className='flex flex-col gap-4 text-sm sm:w-1/6 sm:items-center'>
